...
echo "Test 3 - Cluster WordCount"

DIM="5G"
#DIM="10G"

FILE="big_cluster.txt"

echo "Creazione del file $FILE di dimensioni $DIM in corso..." 
...
echo "Operazione di WordCount Spark Job cluster in corso..." 
...
echo "Operazione di WordCount Spark Job cluster completata."
